...
<div class="sidebar-nav">
    ...
    <a href="<?php echo e(route('global-view')); ?>" class="nav-item active">
        GLOBAL VIEW
    </a>

   <a href="<?php echo e(route('tube.mapping')); ?>" class="nav-item">
        TUBE MAPPING
     </a>

    <a href="<?php echo e(route('rla-analysis')); ?>" class="nav-item">
        RLA ANALYSIS
    </a>

    <a href="<?php echo e(route('maintenance')); ?>" class="nav-item">
        MAINTENANCE
    </a>
        ...
        <div class="section-block" style="padding-top:2px;">
            ...
            <div class="header-title-bar">
                <div class="title-left">
                    ...
                    <h2>GLOBAL VIEW: BOILER UNIT <?php echo e($defaultUnit); ?> STATUS & RISK MAP</h2>
                </div>
                ...
                <div style="display:flex;align-items:center;gap:8px;">
                    ...
                    <select id="unit-dd" class="filter-select" style="width:130px;">
                        <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($u); ?>" <?php if($u === $defaultUnit): echo 'selected'; endif; ?>><?php echo e($u); ?></option>
                ...
                <div style="display:flex;align-items:center;gap:8px;">
                    ...
                    <select id="year-dd" class="filter-select" style="width:120px;">
                        <?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($y); ?>" <?php if($y == $defaultYear): echo 'selected'; endif; ?>><?php echo e($y); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
                ...
                <div style="flex:1;min-width:340px;background:linear-gradient(180deg, rgba(0,26,87,0.25) 0%, rgba(14,32,56,1) 100%);border:1px solid rgba(255,255,255,0.06);border-radius:5px;padding:14px;box-shadow:0 6px 20px rgba(0,0,0,.3);">
                    ...
                    <div style="margin-top:12px; display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:14px;
                        ...
                        <span style="display:flex;align-items:center;gap:9px;">
                            <span style="width:14px;height:14px;border-radius:4px;background:<?php echo e($statusColor['Safe']); ?>;flex-shrink:0;"></span>
                            <span style="color:<?php echo e($statusColor['Safe']); ?>;font-weight:800;font-size:12.5px;letter-spacing:.3px;">SAFE &lt;40%</span>
                        </span>
                        <span style="display:flex;align-items:center;gap:9px;">
                            <span style="width:14px;height:14px;border-radius:4px;background:<?php echo e($statusColor['Watch']); ?>;flex-shrink:0;"></span>
                            <span style="color:<?php echo e($statusColor['Watch']); ?>;font-weight:800;font-size:12.5px;letter-spacing:.3px;">WATCH 40–80%</span>
                        </span>
                        <span style="display:flex;align-items:center;gap:9px;">
                            <span style="width:14px;height:14px;border-radius:4px;background:<?php echo e($statusColor['Critical']); ?>;flex-shrink:0;"></span>
                            <span style="color:<?php echo e($statusColor['Critical']); ?>;font-weight:800;font-size:12.5px;letter-spacing:.3px;">CRITICAL &gt;80%</span>
                        </span>
                    </div>
                </div>
            </div>
...
const SECTIONS = <?php echo json_encode($sections, 15, 512) ?>;
const SECTION_LAYOUT = <?php echo json_encode($sectionLayout, 15, 512) ?>;
const STATUS_COLOR = <?php echo json_encode($statusColor, 15, 512) ?>;
const INITIAL_PAYLOAD = <?php echo json_encode($initialPayload, 15, 512) ?>;
const STEEL = '#5b7a99';
...
function renderCards(cards){
    ...
    const icons = {
        pulse: `<img class="icon" src="<?php echo e(asset('images/SVgG.png')); ?>" alt="" width="18" height="18">`,
        gauge: `<img class="icon" src="<?php echo e(asset('images/thermo.png')); ?>" alt="" width="18" height="18">`,
        warning: `<img class="icon" src="<?php echo e(asset('images/pentung.png')); ?>" alt="" width="18" height="18">`,
        bolt: `<img class="icon" src="<?php echo e(asset('images/listrik.png')); ?>" alt="" width="18" height="18">`,
    };
...
</html><?php /**PATH C:\Users\ASUS\Downloads\ProjekS2P_DashboardBoiler-fixed (3)\ProjekS2P_DashboardBoiler-main\resources\views/dashboard.blade.php ENDPATH**/ ?>