...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="sidebar-nav">
      <a href="<?php echo e(route('global-view')); ?>" class="nav-item" style="text-decoration:none;">GLOBAL VIEW</a>
      <a href="<?php echo e(route('tube.mapping')); ?>" class="nav-item" style="text-decoration:none;">TUBE MAPPING</a>
      <a href="<?php echo e(route('rla-analysis')); ?>" class="nav-item active" style="text-decoration:none;">RLA ANALYSIS</a>
      <a href="<?php echo e(route('maintenance')); ?>" class="nav-item" style="text-decoration:none;">MAINTENANCE</a>
    </div>
  </div>
    ...
    <div class="stats-row">
      ...
      <div class="stat-card alerts">
        ...
        <div class="value">
          ...
          <?php echo e($data['active_alerts']); ?> <span class="sub">(Critical: <?php echo e($data['critical_alerts']); ?>)</span>
        </div>
      </div>
...
</html><?php /**PATH C:\Users\ASUS\Downloads\ProjekS2P_DashboardBoiler-fixed (3)\ProjekS2P_DashboardBoiler-main\resources\views/rla-analysis/index.blade.php ENDPATH**/ ?>