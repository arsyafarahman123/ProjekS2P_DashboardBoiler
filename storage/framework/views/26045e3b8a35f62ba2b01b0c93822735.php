...
<head>
<meta charset="UTF-8">
<title><?php echo $__env->yieldContent('title', 'Input Data'); ?> - S2P Boiler Dashboard</title>
...
<div class="flex">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="<?php echo e(route('input-data.index')); ?>" class="nav-item active">INPUT DATA</a>
    </nav>
  </aside>
  ...
  <main class="main">
    ...
    <div class="flex items-center justify-between mb-5">
      ...
      <div class="flex items-center gap-4">
        <span class="text-xs text-slate-400">Login sebagai <span class="text-slate-200 font-semibold"><?php echo e(auth()->user()->name); ?></span></span>
...
<?php /**PATH E:\Data D\ProjekS2P_DashboardBoiler\resources\views/admin/input-data/layout.blade.php ENDPATH**/ ?>